    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Tambah Kegiatan <small>Manajemen Kegiatan</small></h2>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
              ...
              @endif
              <form id="add-role" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('kegiatan.store') }}">
                  {{ csrf_field() }}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kegiatan <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="nama_kegiatan" name="nama_kegiatan" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
