...
@section('title', 'Tambah KARTA BULE')
    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Tambah KARTA BULE <small>Manajemen KARTA BULE</small></h2>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
              ...
              @endif
              <form id="add-role" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('karta-bule.store') }}">
                  {{ csrf_field() }}
