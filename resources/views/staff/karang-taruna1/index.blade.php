      ...
      <div class="row">
            ...
            <div class="x_title">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <a href="{{ route('karta-bule.create') }}" type="button" class="btn btn-round btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data KARTA BULE</a>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="x_content">
              ...
              <table class="table table-hover">
                <thead>
                  ...
                  <tbody>
                    @foreach ($kartaBule as $key => $m)
                      <tr>
                        <th scope="row" class="col-md-1">{{ $kartaBule->firstItem() + $key }}</th>
                        <td>{{ $m->jabatan }}</td>
                        <td>{{ $m->pejabat }}</td>
                        <td class="col-md-2">
                          <a href="{{ route('karta-bule.edit', $m->detail_id) }}" type="button" class="btn btn-round btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
              ...
              @else
              <h3 style="text-align: center;vertical-align: middle;">Data Karang Taruna Bulu Lor Wetan belum ditambahkan</h3>
              @endif
              {{-- pagination --}}
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div>Menampilkan {{ $kartaBule->firstItem() }} sampai {{ $kartaBule->lastItem() }} dari total {{ $kartaBule->total() }} Anggota</div>
                </div>
              </div>
              <br>
              <div class="row">
        ...
        <script type="text/javascript">
          function deleteData(id){
             var id = id;
             var url = '{{ route("karta-bule.destroy", ":id") }}';
